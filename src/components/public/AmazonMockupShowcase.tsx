...
import AmazonAnimatedDashboard from "./AmazonAnimatedDashboard";

interface AmazonMockupShowcaseProps {
  currentIndex: number;
  direction: number;
}
...
export default function AmazonMockupShowcase({ currentIndex }: AmazonMockupShowcaseProps) {
        ...
        return (
          ...
          >
            ...
            <div className="w-full h-full relative overflow-hidden">
              ...
              >
                <AmazonAnimatedDashboard key={i === centerIndex ? `active-${slide.id}` : `static-${slide.id}`} theme={slide.theme} isActive={i === centerIndex} layoutId={slide.id} />
              </div>
            </div>
          </motion.div>
        );
